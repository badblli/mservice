        ...
        <v-card class="">
            ...
            <v-card-text>
              ...
              autofocus />-->
                    ...
                    <v-col cols="12" sm="6">
                        <v-text-field density="compact" v-model="forms.BinCode" label="BinCode" hide-details
                    ...
                    <v-col cols="12" sm="6">
                        <v-text-field density="compact" v-model="forms.Organization" label="Organization" hide-details
                            variant="outlined">
